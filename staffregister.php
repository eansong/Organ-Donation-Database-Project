										...
										if($queryInsert2)
										{
											...
											else
											{
												...
												if($queryInsert3)
												{
													...
													$mail->Body    = "Dear {$accountinfo_firstname}, your registration is complete! You can now login at our site. Your username: {$useraccount_username} and your password is: {$useraccount_password1} Thank you for choosing St. Teresa's Organ Donation!";
													...
													{
														echo "<b>An email has been sent with your information Thank You for signing up with St. Teresa's Organ Donation.</b>";
														$connection->close();   				
													} 	
												}
												else
