		...
		if($_POST['submitbutton'])
		{
			...
			if($email) //email was filled in 
			{
				...
				if($numberOfRows == 1)
				{
					...
					$subject = "St. Teresa's Organ Donation Username Recovery"; 
					$message = "Dear {$databasefirstName}, your current username is: {$databaseUserName} <br> Thank you for you using St. Teresa's.";
