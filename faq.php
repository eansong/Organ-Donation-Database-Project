...
<!-- Nav end -->
	...
	<div class = "priority" align = "center">
		...
		<p><strong>Do I need to be a citizen of the United States to donate?</strong></p>
		<p>Although some other organizations allow non-citizens to donate, we only allow United States citizens to donate.</p>
