			...
			if($user) //user is filled in 
			{
				if($email) // if email was filled in and has address sign
				{
					...
					if($numberOfRows == 1)
					{
						...
						$subject = "St. Teresa's Organ Donation Password Recovery"; 
						$message = "Dear customer, your current password is: {$databasepassword}. Thank you for you using St. Teresa's.";
